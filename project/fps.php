...
<img src="images/paypal_logo.png" width="300" height="200" />
  ...
  <div class="contentboxleft">
    ...
    <center>
<?
require_once ('productphpfiles/bf4.php');
require_once ('productphpfiles/dayz.php');
?>
	</center>
	</div>
    <div class="productlisting">
<?
require_once ('productphpfiles/mw2.php');
require_once ('productphpfiles/borderlands.php');
?>
	</div>
  </div>
