...
<div class="lowerbox"><img src="images/paypal_logo.png" width="300" height="200" />
<BR /><BR /><BR /><BR /><BR /><BR />
<img src="images/Verified-by-VISA-Logo.jpg" width="300" height="200" /></div>
  </div>
  ...
  <?
	...
	if($ses_userid != null){
			if($ses_userid == session_id() && $ses_user != ""){
				...
				echo "<center>";
				echo "<BR /><BR />";
				echo "Please Login First or Register";
				echo "<BR /><BR />";
				echo "Login/Register to the right &#8594;";
				echo "</center>";
			}
	}else{
				echo "<center>";
